...
# Read JSON file
with open(" ", "r") as f: #your path to /FourierAttention/compressed_dims_file/llama3.2-3b/compressed_dims_4k_uniform.json"
    data = json.load(f)

# Extract specified layer indices
indices = data["Layer_26"]["self_attn.k_proj"]

# Sort
indices = sorted(indices)

# Chunk and histogram parameters
chunk_size = 128
bin_size = 16
...
for i in range(num_chunks):
    ...
    # Map relative indices to new sorted positions
